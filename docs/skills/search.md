...
Из коробки ИИ-агенты (Claude Desktop, Claude Code) ищут паршиво. Поиск подключается через MCP -- как приложение на телефон.
...
ИИ галлюцинирует API, названия функций и параметры. Context7 подключает актуальную документацию и галлюцинаций меньше.
