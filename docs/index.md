...
<p style="text-align:center; color:var(--md-default-fg-color--light); margin-bottom:1.5rem;">Что реально скачивают вайбкодеры · <em>звёзды актуальны на 16 апреля 2026, из GitHub API</em></p>
...
<div class="cat-count">6 шт, от бесплатных до топа</div>
<div class="cat-desc">ИИ сам делает задачи — кодит, ищет, пишет</div>
</a>
...
<div class="cat-name">Готовые промпты</div>
<div class="cat-count">2 шт, скопировать и вставить</div>
<div class="cat-desc">Чтоб ИИ отвечал по делу, без воды</div>
</a>
...
<div class="cat-emoji">🔌</div>
<div class="cat-name">Интеграции</div>
<div class="cat-count">6 шт (MCP-подключения)</div>
<div class="cat-desc">Подключи ИИ к Gmail, AmoCRM, Slack</div>
</a>
