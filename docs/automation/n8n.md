...
Связка Claude Code + n8n -- рабочая связка для автоматизации. Claude работает мозгом: создаёт workflows в n8n через API, мониторит логи, находит ошибки и чинит их сам.
