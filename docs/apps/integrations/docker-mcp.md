...
<div class="video-embed">
  <iframe src="https://www.youtube-nocookie.com/embed/1Tu0c1zuz70" title="Docker MCP Toolkit tutorial — Docker" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
</div>

<p class="video-caption">Обзор: Docker — «Add MCP Servers to Claude Code with Docker MCP Toolkit (Docker Tutorial)»</p>
