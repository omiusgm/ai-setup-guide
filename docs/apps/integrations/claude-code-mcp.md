...
<div class="video-embed">
  <iframe src="https://www.youtube-nocookie.com/embed/HA9ckyV_oHU" title="Claude Code MCP обзор — Иван — ИИ на практике" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
</div>

<p class="video-caption">Обзор: Иван — ИИ на практике — «Claude Code создал мне команду AI-агентов (Claude Code + Skills + MCP)»</p>
