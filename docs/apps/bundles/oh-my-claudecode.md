...
1. Установил — файлы сами разложились
2. В Claude Code: `/agents` — видишь список 32 новых
3. Выбрал нужного (например `writer` для текстов)
4. Написал задачу — агент работает
5. Роутинг сам решает: если задача простая, уйдёт на Haiku
