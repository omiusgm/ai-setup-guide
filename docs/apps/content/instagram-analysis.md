...
**Кидаешь ИИ ссылку на Reel или профиль — получает транскрипт, визуальный разбор, hook, CTA, оценку вовлечения. 3 класса решений — от локального до облачного «под ключ».**
