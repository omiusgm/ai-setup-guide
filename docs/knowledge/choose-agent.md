...
Раньше, с nano-banana / Midjourney / Ideogram через API, каждая картинка стоила токенов. Давать агенту свободу было страшно: один кривой промпт в цикле — и к концу месяца счёт на $200 за картинки, которых ты даже не видел. Подписка это убивает: один раз заплатил — агент может крутить хоть 50 вариантов. Денег больше не станет, упрёшься в суточный лимит и подождёшь.
