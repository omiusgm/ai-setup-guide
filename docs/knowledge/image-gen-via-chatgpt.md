...
![Слева: ёж в куче счетов от платных сервисов. Справа: тот же ёж с одним устройством на чистом столе](../assets/preview/imggen-before-after.png)
...
![Ёж-детектив с лупой над терминалом, в котором одна строка подсвечена красным (ошибка)](../assets/preview/imggen-debug.png)
